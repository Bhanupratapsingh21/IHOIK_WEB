...
export function PikaHero() {
  ...
  return (
    ...
    >
      {/* Outer rounded card with thick white border */}
      <div className="relative rounded-2xl md:rounded-3xl border-4 border-white/90 bg-[#F7C948] shadow-[0_10px_40px_-15px_rgba(0,0,0,0.25)] md:shadow-[0_25px_60px_-20px_rgba(0,0,0,0.35)] ring-1 ring-white/30 overflow-hidden">
        ...
        <div className="relative px-4 sm:px-6 pt-2 md:px-10">
          {/* Oversized background word with animation */}
          <div
            aria-hidden="true"
          ...
          <div className="relative z-10 flex flex-col items-end gap-6 md:gap-8 lg:gap-20 md:flex-row">
            {/* Left content */}
            <div className="flex flex-col gap-4 pt-16 md:pt-16 lg:pt-64 md:pb-14 w-full md:w-1/2">
              <p className={`text-ellipsis font-sans text-[12vw] leading-none font-extrabold text-[#7A1C1C] sm:text-[14vw] md:text-[10vw] lg:text-[90px] transition-all duration-700 ease-out delay-300 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'
                }`}>
                Only In Kota
              </p>
              ...
              <div className={`mt-4 md:mt-6 flex flex-wrap items-center gap-4 md:gap-8 text-xs sm:text-sm transition-all duration-700 ease-out delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                ...
                <Link href="https://www.instagram.com/ithappensinkota/" className="inline-flex items-center gap-1 md:gap-2 text-[#1B1B1B]/80 hover:text-[#1B1B1B] transition-colors duration-300 hover:scale-105">
                  <Instagram className="h-4 w-4 md:h-5 md:w-5" aria-hidden="true" />
                  <span className="font-semibold">Follow US ON IG</span>
                </Link>
                <Link href="https://www.youtube.com/@ihoikmedia" className="inline-flex items-center gap-1 md:gap-2 text-[#1B1B1B]/80 hover:text-[#1B1B1B] transition-colors duration-300 hover:scale-105">
            ...
            <div className={`relative mx-auto w-full max-w-[280px] sm:max-w-xs md:max-w-sm transition-all duration-1000 ease-out delay-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'
              ...
              <div className="animate-float">
                {/* Decorative plate to echo tail shape */}
                <div
                  aria-hidden="true"
                ...
                <Image
                  src={"https://res.cloudinary.com/djwzwq4cu/image/upload/e_background_removal/f_png/v1756568674/White_and_Black_Minimalist_Phone_Mockup_Instagram_2332323_fcrnhq.jpg"}

  ...
  return (
    <header
      className={`fixed top-4 left-1/2 transform -translate-x-1/2 z-50 transition-all duration-300 ${scrolled
        ? 'bg-white/90 backdrop-blur-md shadow-lg rounded-full border border-gray-100'  // Glassy background when scrolled
        : 'bg-white/80 backdrop-blur-sm shadow-md rounded-full border border-gray-100'
        }`}
    ...
    >
      ...
      >
        <div
          id="mobile-menu"
          className="md:hidden bg-white/95 backdrop-blur-md shadow-xl rounded-2xl mx-4 mt-2 border border-gray-100"
        >

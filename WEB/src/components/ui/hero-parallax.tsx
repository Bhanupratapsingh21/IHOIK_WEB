    ...
    <div className="max-w-7xl relative mx-auto py-20 md:py-28 px-4 w-full left-0 top-0 z-30">
      <div className="flex flex-col items-start space-y-8 md:space-y-10 transition-all duration-1000 ease-out delay-500 opacity-100 translate-y-0">
        <div className="flex flex-col items-start w-full">
          <div className="mb-6 md:mb-8  transition-all duration-1000 ease-out opacity-100 translate-y-0">
            <Image
          ...
          <h1 className="text-start text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-4 leading-tight drop-shadow-2xl tracking-tight">
            <span className="text-[#7A1C1C]">Kota's</span>
            <br />
            Hustle. Heart &amp; Stories
          </h1>
          <p className="text-center text-lg md:text-xl text-white/90 max-w-xl drop-shadow-md mb-6">
            Because Kota is more than coaching — it's a journey.
          </p>
          <Link href={"/blogs"} className="mt-4 px-10 py-3 bg-[#7A1C1C] hover:bg-[#9a2c2c] text-white rounded-full font-semibold text-lg shadow-lg transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-[#7A1C1C] focus:ring-offset-2">
            Explore Stories
          </Link>
        </div>
      </div >
